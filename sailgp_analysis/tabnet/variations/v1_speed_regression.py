"""V1 — Boat speed regression."""
from __future__ import annotations

from pathlib import Path

from sailgp_analysis.tabnet.data_prep import build_v1_dataset
...
def run(data_root=None, output_dir: Path | None = None) -> EvalResult:
    ds = build_v1_dataset(data_root)
    return run_variation("v1", ds, output_dir or default_output_dir())
